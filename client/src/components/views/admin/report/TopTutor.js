...
const TopTutor = () => {
    ...
    const pdfBar = () => {
        ...
        pdf.setFontSize(30)
        pdf.text(10, 20, 'Top 10 Rated Tutors')
    ...
    const downloadPdf = () => {
        ...
        doc.setFontSize(30)
        doc.text(10, 20, 'Top 10 Rated Tutors')
    ...
    return (
        ...
        <Fragment>
            <AdminHeader />
            <MetaData title={'Reports - Top Rated Tutors'} styles={'html, body, .App { background-color:  !important; } .home-navbar {background: #141414 !important;} footer p {color: #000000 !important;}'} />
            <Fragment>
                {loading ? <Loader /> : (
                    <div className="home-section">
                        ...
                        <div className="container-fluid">
                            <div className="container-fluid" id="subjectContainer">
                                <h1 className="h1 mb-2 text-gray-800">Top Rated Tutors</h1>
