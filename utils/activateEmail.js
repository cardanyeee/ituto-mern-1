    ...
    * {
    ...
    <!--<![endif]-->
        <div className="wrapper" style="min-width: 320px;background-color: #f5f7fa;" lang="x-wrapper">
          ...
          <h1 className="size-48" style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #44a8c7;font-size: 36px;line-height: 43px;font-family: roboto;text-align: center;" lang="x-size-48"><span className="font-bitter"><font color="#ffffff"><strong>Welcome to iTuto!</strong></font></span></h1>
        </div>
          ...
          <h2 className="size-24" style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #44a8c7;font-size: 20px;line-height: 28px;text-align: center;" lang="x-size-24"><strong>Verify Your Email</strong></h2>
              ...
              <img className="gnd-corner-image gnd-corner-image-center gnd-corner-image-bottom" style="border: 0;display: block;height: auto;width: 90%;max-width: 720px;" alt="" width="600" src="https://res.cloudinary.com/practicaldev/image/fetch/s--Bx8RoTER--/c_imagga_scale,f_auto,fl_progressive,h_1080,q_auto,w_1080/https://faruknasir.com/images/blog/2021/verification_url.png">
            </div>
